        ...
        <Modal.Body>
          ...
          >
            ...
            <Form.Group className='my-2' controlId='size'>
              <Form.Label>Update Brand</Form.Label>
            ...
            <Form.Group className='my-2' controlId='subject'>
              <Form.Label>Update Device Type</Form.Label>
